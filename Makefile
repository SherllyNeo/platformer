...
bilo: src_files/main.c src_files/config.h
	gcc $(CFLAGS) $(LDFLAGS) src_files/main.c -o bin/bilo $(LDLIBS)
install: src_files/main.c src_files/config.h
	gcc $(CFLAGS) $(LDFLAGS) src_files/main.c -o bin/bilo $(LDLIBS) && cp -f ./bin/bilo $(HOME)/.local/bin/
web: src_files/main.c src_files/config.h
	emcc src_files/main.c -o bin/bilo.html $(CWEB) -lm
